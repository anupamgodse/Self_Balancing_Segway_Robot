...
#define PERIOD_TOUCH_SENSOR_TASK  (1)
#define PERIOD_GYRO_TASK  (2)
#define PERIOD_BALANCE_TASK  (4)
#define PERIOD_BLUETOOTH_TASK  (8)
...
extern void update_gyro_data(intptr_t unused);
extern void task_activator(intptr_t tskid);
extern void touch_sensor_task(intptr_t unused);
extern void bluetooth_task(intptr_t unused);
